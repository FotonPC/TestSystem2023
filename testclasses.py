...
class MatchTestPack:
    def __init__(self, title='', keys=None, values=None, thanks_text='', size_grid = None, size_button = None, size_label=None, font_button='TkDefaultFont', font_label='TkDefaultFont', grid_label = None, grid_button=None, ):
        if keys is None:
            keys = []
        if values is None:
            values = []
